...
int verificarContador(int count){
    if(count > 9){
        return 0;
    } else if(count < 0){
        return 9;
...
void numeroDois(){
    npClear();
    int ledsIndex[10] = {1,2,3,6,11,12,18,21,22,23};
    for(int i = 0; i < 10; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroTres(){
    npClear();
    int ledsIndex[10] = {1,2,3,8,11,12,18,21,22,23};
    for(int i = 0; i < 10; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroQuatro(){
    npClear();
    int ledsIndex[9] = {1,8,11,12,13,16,18,21,23};
    for(int i = 0; i < 9; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroCinco(){
    npClear();
    int ledsIndex[11] = {1,2,3,8,11,12,13,16,21,22,23};
    for(int i = 0; i < 11; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroSeis(){
    npClear();
    int ledsIndex[12] = {1,2,3,6,8,11,12,13,16,21,22,23};
    for(int i = 0; i < 12; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroSete(){
    npClear();
    int ledsIndex[9] = {1,8,10,11,12,18,21,22,23};
    for(int i = 0; i < 9; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numeroOito(){
    npClear();
    int ledsIndex[13] = {1,2,3,6,8,11,12,13,16,18,21,22,23};
    for(int i = 0; i < 13; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
void numerNove(){
    npClear();
    int ledsIndex[12] = {1,2,3,8,11,12,13,16,18,21,22,23};
    for(int i = 0; i < 12; i++){
        npSetLED(ledsIndex[i], 65,65,0);
    }
    npWrite();
...
int main()
{
    ...
    while (true) {
        ...
        case  1:
            ...
            // Desenha o número 1 na matriz de LEDs
            numeroUm();
            break;
        case  2:
            printf("Imprimindo número 2\n");
            // Desenha o número 2 na matriz de LEDs
            numeroDois();
            break;
        case 3: 
            printf("Imprimindo número 3\n");
            // Desenha o número 3 na matriz de LEDs
            numeroTres();
            break;
        case 4:
            printf("Imprimindo número 4\n");
            // Desenha o número 4 na matriz de LEDs
            numeroQuatro();
            break;
        case 5:
            printf("Imprimindo número 5\n");
            // Desenha o número 5 na matriz de LEDs
            numeroCinco();
            break;
        case 6:
            printf("Imprimindo número 6\n");
            // Desenha o número 6 na matriz de LEDs
            numeroSeis();
            break;
        case 7:
            printf("Imprimindo número 7\n");
            // Desenha o número 7 na matriz de LEDs
            numeroSete();
            break;
        case 8:
            printf("Imprimindo número 8\n");
            // Desenha o número 8 na matriz de LEDs
            numeroOito();
            break;
        case 9:
            printf("Imprimindo número 9\n");
            // Desenha o número 9 na matriz de LEDs
            numerNove();
            break;
        default:
            printf("Valor inválido\n");
            printf("Valor do contador: %d\n", contador);
            contador = verificarContador(contador);
            break;
        }
    }
}
